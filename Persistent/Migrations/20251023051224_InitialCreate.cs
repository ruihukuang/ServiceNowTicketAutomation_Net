        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceOwner = table.Column<string>(type: "TEXT", nullable: true),
                    Priority = table.Column<string>(type: "TEXT", nullable: true),
                    Guided_SLAdays = table.Column<long>(type: "INTEGER", nullable: true),
                    Met_SLA = table.Column<string>(type: "TEXT", nullable: true),
                    ExtraDays_AfterSLAdays = table.Column<long>(type: "INTEGER", nullable: true),
                    ...
                    Root_Cause_AI = table.Column<string>(type: "TEXT", nullable: true),
